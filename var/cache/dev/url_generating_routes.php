...
return [
    ...
    'cart_update' => [['id', 'quantity'], ['quantity' => 1, '_controller' => 'App\\Controller\\CartController::cart_update'], ['id' => '\\d+'], [['variable', '/', '[^/]++', 'quantity', true], ['variable', '/', '\\d+', 'id', true], ['text', '/cart/update']], [], [], []],
    'cart_delete' => [['id'], ['_controller' => 'App\\Controller\\CartController::cart_delete'], [], [['variable', '/', '[^/]++', 'id', true], ['text', '/cart/delete']], [], [], []],
